...
#define KX_DRIVER_DATE        01/08/2020 //MM/GG/YYYY


#define KX_VERSION_DWORD        0x51003553
#ifdef KX_DEBUG
 #define KX_DRIVER_VERSION_STR        "5.30.00.0 - debug"
#else
 #define KX_DRIVER_VERSION_STR        "5.30.00.0"
#endif
#define KX_DRIVER_VERSION        5,30,0,0
#define KX_DRIVER_VERSION_        5.30.0.0
#ifdef KX_DEBUG
 #define KX_VERSION_STR            "5, 30, 00, 0 - debug"
#else
